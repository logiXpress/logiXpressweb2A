...
class ReponsesAdminC
{
    ...
    public function deleteReponse(int $id_reponse): bool
    {
        ...
        try {
            ...
            if ($reponse) {
                ...
                $recC->changerStatut($reponse['id_reclamation'], 'In Progress');
            }
    ...
    public function modifierReponse($id, $newReponse)
    {
        $sql = "UPDATE reponses_admin SET Reponse = :reponse WHERE id_reponse = :id";
        $db = config::getConnexion();
        try {
    ...
    public function ajouterReponse(ReponsesAdmin $reponse): int
    {
        ...
        try {
            ...
            $reclamationC->changerStatut($reponse->getIdReclamation(), 'Resolved');
    ...
    public function getAllReponsesAdmin()
{
    $db = config::getConnexion();
    try {
        $query = "SELECT * FROM reponses_admin";
    ...
    public function updateReponse(ReponsesAdmin $reponse, int $id_reponse): bool
    {
        ...
        try {
            ...
            if ($req->rowCount() > 0) {
                $recC = new ReclamationC();
                $recC->changerStatut($reponse->getIdReclamation(), 'In Progress');
            }
