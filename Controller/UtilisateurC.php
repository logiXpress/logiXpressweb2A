...
class UtilisateurC {
    ...
    public function ajouterUtilisateur($utilisateur) {
        ...
        $sql = "INSERT INTO Utilisateurs (Nom, Prénom, Email, Mot_de_passe, Type, phone_number) 
    ...
    public function modifierUtilisateur($utilisateur) {
        $sql = "UPDATE utilisateurs SET Nom = :nom, Prénom = :prenom, Email = :email, Mot_de_passe = :motDePasse, Type = :type ,phone_number = :phone_number WHERE id_utilisateur = :id";
