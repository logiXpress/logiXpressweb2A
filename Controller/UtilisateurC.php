...
class UtilisateurC
{
    ...
    public function ajouterUtilisateur($utilisateur) {
        ...
        $query = "INSERT INTO Utilisateurs (Nom, Prénom, Email, Mot_de_passe, Type, phone_number, profile_picture) 
        ...
        $stmt->bindParam(':profile_picture', $utilisateur->getProfilePicture(), PDO::PARAM_LOB);  // Bind profile picture as LOB (Large Object)
        $stmt->execute();
    }
    ...
    public function modifierUtilisateur($utilisateur)
    {
        try {
            ...
            $stmt->execute([
                ...
                ':profile_picture' => $utilisateur->getProfilePicture(),  // Bind profile picture for update
