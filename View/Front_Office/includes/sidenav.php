...
<div class="sidebar" data-color="white" data-background-color="rose" data-image="../../../public/assets/img/sidebar-1.jpg">
  ...
  <div class="sidebar-wrapper">
    ...
    <div class="user mt-3 mb-2 text-center">
      <div class="photo">
        <img src="<?php echo BASE_URL; ?>/public/assets/img/faces/avatar.jpg" class="rounded-circle" style="width: 60px; height: 60px;">
      </div>
      <div class="user-info mt-2">
        <a data-toggle="collapse" href="#userOptions" class="username d-block">
          <span>
        ...
        <div class="collapse" id="userOptions">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../../../Acceuil/signin/basic.php">
    ...
    <ul class="nav">
      ...
      <!-- Forms (Collapsible) -->
      <?php
      $formPages = ['dashboard.php','ajouterlivraison.php', 'extended.html', 'validation.html', 'wizard.html'];
