...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        $id_livraison = filter_var($_POST['id_livraison'], FILTER_SANITIZE_NUMBER_INT);
        $adresse_livraison = filter_var($_POST['adresse_livraison'], FILTER_SANITIZE_STRING);
        $mode_paiement = filter_var($_POST['mode_paiement'], FILTER_SANITIZE_STRING);
