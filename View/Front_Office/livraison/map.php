      ...
      <div class="content">
        ...
        <script>
          ...
          async function updateMap() {
            try {
              let livreurResponse = await fetch('http://localhost/Gestion_Livraison_1/api/getLivreursLocation.php');
              let livreurData = await livreurResponse.json();

              let livraisonResponse = await fetch('http://localhost/Gestion_Livraison_1/api/getLivraisonLocation.php');
